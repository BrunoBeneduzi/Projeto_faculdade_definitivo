...
export type Perfil={idPublico:string;urlPublica:string;nome:string;sobrenome:string;sexo:string;contatoEmergencia:string;telefoneContatoEmergencia:string;tipoSanguineo:string;alergias:string[];medicamentos:string[];doencas:string[];cirurgias:string[]};
